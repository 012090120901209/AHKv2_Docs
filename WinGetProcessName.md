...
This function returns the name of the process that owns the specified
window. For example: notepad.exe.
...
[WinGetPID](WinGetPID.htm), [WinGetProcessPath](WinGetProcessPath.htm),
