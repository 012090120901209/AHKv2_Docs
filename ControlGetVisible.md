...
This function returns 1 (true) if the specified control is visible, or 0
(false) if hidden.
...
[ControlHide](ControlHide.htm), [ControlShow](ControlShow.htm), [Visible
property (GuiControl object)](GuiControl.htm#Visible), [Control
