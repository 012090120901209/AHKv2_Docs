...
**Robert Yaklin:** A lot of tireless testing to isolate bugs, a great
first draft of the installer, as well as great suggestions for how
commands **ought** to work :)

**Jason Payam Ahdoot:** For suggesting and describing floating point
support.

**Jay D. Novak:** For discovering many Win9x problems with the Send
...
**Rajat:** For creating stylish replacements for the original AHK icons;
...
**Thaddeus Beck (Beardboy):** For NT4 testing to fix GetKeyState and the
Send command; for a lot of help on the forum; and for many suggestions
and bug reports.

**Gregory F. Hogg of Hogg\'s Software:** For writing the source code for
multi-monitor support in the [SysGet](../lib/SysGet.htm) command.

**Aurelian Maga:** For writing the source code for
