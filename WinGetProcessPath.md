...
Returns the full path and name of the process that owns the specified
window.
...
This function returns the full path and name of the process that owns
the specified window. For example: C:\\Windows\\System32\\notepad.exe.
...
[WinGetPID](WinGetPID.htm), [WinGetProcessName](WinGetProcessName.htm),
[Process functions](Process.htm), [Win functions](Win.htm), [Control
