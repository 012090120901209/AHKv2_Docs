...
If you additionally want to prevent a control\'s shortcut key
(underlined letter) from working, disable the control via
...
[ControlShow](ControlShow.htm),
[ControlGetVisible](ControlGetVisible.htm), [WinHide](WinHide.htm),
[Visible property (GuiControl object)](GuiControl.htm#Visible), [Control
