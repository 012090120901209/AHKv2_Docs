...
This function returns the selected text in an Edit control. If no text
is selected, an empty string is returned. Certain types of controls,
such as RichEdit20A, might not produce the correct text in some cases
(e.g. Metapad).
...
An [Error](Error.htm) or [OSError](Error.htm#OSError) is thrown if there
was a problem retrieving the text.
...
[EditGetLine](EditGetLine.htm), [EditPaste](EditPaste.htm), [Control
