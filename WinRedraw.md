...
This function attempts to update the appearance/contents of a window by
...
[WinMove](WinMove.htm). If that does not work, try
[WinHide](WinHide.htm) in combination with [WinShow](WinShow.htm).
