...
[ControlShowDropDown](ControlShowDropDown.htm), [Control
functions](Control.htm)

## Examples {#Examples}

See [example #1](ControlShowDropDown.htm#ExBasic) on the
[ControlShowDropDown](ControlShowDropDown.htm) page.
