...
Returns a non-zero number if the specified window is maximized or
minimized.
...
This function returns a number indicating the current state of the
specified window:

-   -1: The window is minimized ([WinRestore](WinRestore.htm) can
    unminimize it).
-   1: The window is maximized ([WinRestore](WinRestore.htm) can
    unmaximize it).
...
[WinMaximize](WinMaximize.htm), [WinMinimize](WinMinimize.htm), [Win
